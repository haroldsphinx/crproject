...
app.get('/register-request', function (req, res) {
    ...
    process.getRegisterRequest(req, xparams, function (status, data, total_data) {
//console.log("totla=>"+total_data);

        var url = '/register-request?sort_by=' + filter_by + '&q=' + qsearch + '&page=';
         //data[0].datetime = dateFormat(data[0].datetime, 'yyyy-mm-dd HH:MM:ss');
        var params = {
            title: 'Register Request list',
            data: data,
            ...
            active_page: 'register-request'
        };
        //console.log(params);
        res.render('register_request.ejs', params);
    });
